...
description: Emerging adulthood is the time when we start to clear past the struggles of adolescence, start to feel responsible for ourselves, find our personal identity, and do so while we are still closely tied to our parents and family.
...
format:
  html:
    page-layout: article
---
![](mentalhealth1.jpeg){image-width=5em image-height=5em}
