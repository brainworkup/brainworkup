...
format:
  html:
    page-layout: article
sidebar: true
image: adhd-girls-younger.webp
image-width: 20em
lightbox: true
---

![](adhd-girls-younger.webp "Executive Function"){width=20em height="100%" fig-alt="A brainworkup logo for ef."}
