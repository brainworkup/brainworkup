...
aliases:
  - "../docs/conditions-treated/adhd/"
  - "../docs/disorders/adhd.html"
description: >
  An overview of ADHD and the process of evaluating ADHD across the lifespan, from childhood to adulthood, specific to services provided by Dr. Trampush @ BrainWorkup, LLC.
format:
  html:
    page-layout: article
hide-description: true
image: adhd-black-384.webp
image-width: 20em
...
![](adhd-black-384.webp "ADHD"){width=20em fig-alt="A brainworkup logo for ADHD."}
